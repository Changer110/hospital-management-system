...
urlpatterns = [
    ...
    # APPOINTMENT URLS
    path('Display/appointment/<int:employee_id>/' , appointment , name='display_appointment'),
    path('Add/appointment/<int:employee_id>/', add_appointment, name='add_appointment'),
    path('Update/appointment/update/<int:appointment_id>/',change_appointment, name='update_appointment'),
